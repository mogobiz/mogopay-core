...
/*----------------------------------------------------------------------
  Topic		: Exemple SERVLET de traitement de la r�ponse
  Version 	: P615
 *---------------------------------------------------------------------*/
...
/*
 |======================================================================
 |
 |   	main programm 	: traitement de la r�ponse manuelle
 |			  Dans cet exemple, les donn�es de la transaction
 |			  sont d�crypt�es et affich�es sur le navigateur
 |			  de l'internaute.
 |
 |======================================================================
 */
...
public class ResponseServlet extends HttpServlet {
	...
	/* 	Redirection de la sortie DEBUG vers le navigateur. 
		Par d�faut le mode DEBUG est redirig� vers la sortie standard du serveur d'application.
	*/
