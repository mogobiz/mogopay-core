...
/*----------------------------------------------------------------------
  Topic		: Exemple SERVLET traitement de la requ�te de paiement
  Version 	: P615
 *---------------------------------------------------------------------*/
...
/*
 |======================================================================
 |
 |   	main programm 	: traitement de la requ�te de paiement
 |					 	: Dans cet exemple, on affiche un formulaire de
 |						connection au serveur de paiement � l'internaute.
 |
 |======================================================================
 */
...
public class RequestServlet extends HttpServlet {
    ...
    try{
      ...
      */
      ...
      // Affectation du montant de la transaction dans la plus petite unit�
      // mon�taire du pays
      // ex : 123,00 Euros ==> 12300 (currency_code = 978)
      call.setValue("amount","12300");

      // Affectation du code mon�taire ISO 4217 pour la transaction
      // ex : Euro ==> 978
      call.setValue("currency_code","978");

      // Affectation d'un num�ro identifiant pour la transaction
      // Attention aux reserves sur l'affectation automatique
      // cf Guide du developpeur
      // call.setValue("transaction_id","123456");

      // Valorisation des autres donn�es de la transaction
      // facultatives, � compl�ter au besoin
      ...
      // call.setValue("order_id","");
  	  ...
  	  // Elles n�cessitent l'installation de vos logos et templates sur
      ...
      // Insertion de la commande dans votre base de donn�es
