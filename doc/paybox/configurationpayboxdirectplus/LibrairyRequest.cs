...
namespace FarInfo.Services.Services
{
    ...
    public class LibrairyRequest
    {
        ...
        public LibrairyRequest(string url)
            : this()
        {
            m_url = url;
        }
        ...
        public LibrairyRequest(string url, NameValueCollection values)
            : this(url)
        {
            m_values = values;
        }
        ...
        /// </summary>
        /// <returns></returns>
        public string TramePost(NameValueCollection collection)
        {
            StringBuilder parameters = new StringBuilder();
            ...
            string result = parameters.ToString().Replace("{","").Replace("}","");
            return result;
        }
        /// <summary>
