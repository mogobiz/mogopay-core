package mogopay.tests

import java.util.{Calendar, UUID}

import mogopay.es.EsClient
import mogopay.model.Mogopay._
import mogopay.session.{ESSession, ESBackend, Session}
...
object TestApp extends App {
  ...
  val created = EsClient.update(account.copy(email = "you@you.com"), false)
  val deleted = EsClient.delete[Account](Uuid)
  println(obj)
  println(created)
  println(deleted)
