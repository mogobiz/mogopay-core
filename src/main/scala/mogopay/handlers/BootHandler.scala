...
import mogopay.model.Mogopay.AccountStatus.AccountStatus
import mogopay.model.Mogopay.CBPaymentProvider.CBPaymentProvider
import mogopay.model.Mogopay.CBPaymentMethod.CBPaymentMethod
...
object BootHandler {
  ...
  private def initDB() = mogopay.es.Mapping.set
