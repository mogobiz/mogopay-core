...
object DBInitializer {
  ...
  private def fillDB() {
    ...
    createClientAccount("eeeeeeee-29b4-465a-aedd-1784ee6e3929", "customer-payline-custom@merchant.com", "Payline Custom", "Customer", merchantAccountInfoPaylineCustom, false)
    createClientAccount("ffffffff-29b4-465a-aedd-1784ee6e3929", "customer-sips-custom@merchant.com", "SIPS Custom", "Customer", merchantAccountInfoSIPSCustom, false)
