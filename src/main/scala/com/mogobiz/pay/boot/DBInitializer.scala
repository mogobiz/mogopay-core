...
object DBInitializer {
  ...
  private def fillDB() {
    ...
    var merchantAccountInfoANet = createMerchantAccount("bbbbbbbb-bbbb-bbbb-bbbbbbbbbbbb", "mogopay-anet@merchant.com",
    ...
    createClientAccount("e6ca3ff5-ee4f-4184-b3e0-0adde58c77c6", "client-anet@merchant.com", "ANet client", "Test", merchantAccountInfoANet, false)
    ...
    val APPLEPAY = Map("paypalUser" -> "hayssams-facilitator_api1.yahoo.com", "paypalPassword" -> "1365940711", "paypalSignature" -> "An5ns1Kso7MWUdW4ErQKJJJ4qi4-AIvKXMZ8RRQl6BBiVO5ISM9ECdEG")
    val applePayConfig = createPaymentConfig(CBPaymentProvider.APPLEPAY,
