...
object DBInitializer {
  ...
  private def fillDB() {
    ...
    val paypalPayboxExternalConfig = createPaymentConfig(CBPaymentProvider.PAYBOX, PAYPAL, Map(), PAYBOX_EXTERNAL, CBPaymentMethod.EXTERNAL)
    ...
    val paypalPaybox2DSConfig = createPaymentConfig(CBPaymentProvider.PAYBOX, PAYPAL, Map(), PAYBOX_2DS, CBPaymentMethod.THREEDS_NO)
    ...
    val paypalPayline2DSConfig = createPaymentConfig(CBPaymentProvider.PAYLINE, PAYPAL, Map(), PAYLINE, CBPaymentMethod.THREEDS_NO)
    ...
    val paypalSystemPay3DSConfig = createPaymentConfig(CBPaymentProvider.SYSTEMPAY, PAYPAL, Map(), SYS_PAY, CBPaymentMethod.THREEDS_REQUIRED)
    ...
    val paypalSipsExternalConfig = createPaymentConfig(CBPaymentProvider.SIPS, PAYPAL, Map(), SIPS_2, CBPaymentMethod.EXTERNAL)
    ...
    val paypalPaybox3DSConfig = createPaymentConfig(CBPaymentProvider.PAYBOX, PAYPAL, Map(), PAYBOX_3DS, CBPaymentMethod.THREEDS_REQUIRED)
    ...
    val paypalSips3DSPaymentConfig = createPaymentConfig(CBPaymentProvider.SIPS, PAYPAL, Map(), SIPS, CBPaymentMethod.THREEDS_REQUIRED)
    ...
    val merchantAccountInfoSystempayCustom = createMerchantAccount("cccccccc-4567-4602-abd5-4f85e9ff56e6", "mogopay-systempay-custom@merchant.com", "Mogopay Systempay Custom", "TEST", systemPayCustomConfig)
    ...
    val merchantAccountInfoPayboxCustom = createMerchantAccount("dddddddd-4567-4602-abd5-4f85e9ff56e6", "mogopay-paybox-custom@merchant.com", "Mogopay Paybox Custom", "TEST", payboxCustomConfig)
    ...
    val merchantAccountInfoPaylineCustom = createMerchantAccount("eeeeeeee-4567-4602-abd5-4f85e9ff56e6", "mogopay-payline-custom@merchant.com", "Mogopay Payline Custom", "TEST", paylineCustomConfig)
    ...
    val merchantAccountInfoSIPSCustom = createMerchantAccount("ffffffff-4567-4602-abd5-4f85e9ff56e6", "mogopay-sips-custom@merchant.com", "Mogopay SIPS Custom", "TEST", sipsCustomConfig)
    ...
    var merchantAccountInfoANetCustom = createMerchantAccount("f5c4a907-6f73-4ecf-ba34-3c7d97d3d6ba", "mogopay-anet-custom@merchant.com",
      "ANet Custom", "Merchant", paymentConfig12Custom)
    ...
    val applePayClient = createClientAccount("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb", "client-apay@merchant.com",
      "Apple Pay", "Client", applePayMerchant, false, geoCoords = Option("48.871806,2.297987"))
  }
...
object DbInitMain extends App {
  try {
    ...
    secureActionRequest(EsClient().client.prepareDeleteByQuery(Settings.Mogopay.EsIndex).setQuery(new TermQueryBuilder("_type", "Account"))).execute.actionGet
    secureActionRequest(EsClient().client.prepareDeleteByQuery(Settings.Mogopay.EsIndex).setQuery(new TermQueryBuilder("_type", "BOTransaction"))).execute.actionGet
    secureActionRequest(EsClient().client.prepareDeleteByQuery(Settings.Mogopay.EsIndex).setQuery(new TermQueryBuilder("_type", "BOTransactionLog"))).execute.actionGet
    secureActionRequest(EsClient().client.prepareDeleteByQuery(Settings.Mogopay.EsIndex).setQuery(new TermQueryBuilder("_type", "ESSession"))).execute.actionGet
    secureActionRequest(EsClient().client.prepareDeleteByQuery(Settings.Mogopay.EsIndex).setQuery(new TermQueryBuilder("_type", "TransactionSequence"))).execute.actionGet
    secureActionRequest(EsClient().client.prepareDeleteByQuery(Settings.Mogopay.EsIndex).setQuery(new TermQueryBuilder("_type", "TransactionRequest"))).execute.actionGet
  } catch {
