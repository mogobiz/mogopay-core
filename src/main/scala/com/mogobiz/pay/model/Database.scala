...
case class GroupPaymentInfo(returnURLforNextPayers: String, successURL: String, failureURL: String)
...
case class ShippingAddress(uuid: String, active: Boolean = false, address: AccountAddress)
...
case class ShippingDataList(
    @JsonScalaEnumeration(classOf[ShippingPriceErrorRef]) error: Option[ShippingPriceError.ShippingPriceError],
...
case class SelectShippingCart(shippingAddress: AccountAddress, shippingPriceByShopId: Map[String, ShippingData]) {
