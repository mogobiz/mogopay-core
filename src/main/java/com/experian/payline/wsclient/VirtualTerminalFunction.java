...
@XmlType(name = "virtualTerminalFunction", namespace = "http://obj.ws.payline.experian.com", propOrder = {
    "function",
    "label",
    "functionParameter"
})
public class VirtualTerminalFunction {
    ...
    protected List<FunctionParameter> functionParameter;
     ...
     * {@link com.experian.payline.wsclient.VirtualTerminalFunction.FunctionParameter }
     * 
     * 
     */
    public List<FunctionParameter> getFunctionParameter() {
        if (functionParameter == null) {
            functionParameter = new ArrayList<FunctionParameter>();
        }
